...
def main():
    ...
    try:
        ...
        # Note: These offsets are from an older base, let's recalculate from your current one for safety
        ...
        # We use a known good base/offset and recalculate for the current session
        OLD_VICTORY_BASE = 0x7FF748210000
        OLD_C750_BASE = 0x7FF748A9C750
